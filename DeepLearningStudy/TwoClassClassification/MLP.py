...
class Network(tf.keras.Model):
    ...
    def __init__(self, name):
        ...
        self.dense_1 = Dense(16, activation='relu', use_bias=True)
        self.dense_2 = Dense(16, activation='relu', use_bias=True)
        self.dense_3 = Dense(16, activation='relu', use_bias=True)
        self.dense_4 = Dense(2, activation='softmax', use_bias=True)
