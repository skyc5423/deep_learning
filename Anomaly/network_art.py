...
class Generator(tf.keras.Model):
    def __init__(self, num_layer=4):
        ...
        self.conv_mask = Conv2D(1, (3, 3), strides=(1, 1), padding='same', dilation_rate=(1, 1), activation='tanh', kernel_initializer='random_normal')
    ...
    def __call__(self, input_tensor, training):
        ...
        feature_mask = self.conv_mask(feature_4)
