...
class Discriminator(tf.keras.Model):
    def __init__(self, num_layer=4):
        ...
        self.conv_1 = Conv2D(8, (5, 5), strides=(1, 1), padding='same', dilation_rate=(1, 1), kernel_initializer='random_normal')
        self.relu_1 = LeakyReLU()

        # self.conv_2 = Conv2D(16, (5, 5), strides=(1, 1), padding='same', dilation_rate=(1, 1), kernel_initializer='random_normal')
        # self.relu_2 = LeakyReLU()

        self.conv_3 = Conv2D(16, (3, 3), strides=(1, 1), padding='same', dilation_rate=(1, 1), kernel_initializer='random_normal')
        self.relu_3 = LeakyReLU()

        self.conv_4 = Conv2D(32, (3, 3), strides=(2, 2), padding='same', dilation_rate=(1, 1), kernel_initializer='random_normal')
        self.relu_4 = LeakyReLU()

        self.conv_5 = Conv2D(32, (3, 3), strides=(1, 1), padding='same', dilation_rate=(1, 1), kernel_initializer='random_normal')
        self.relu_5 = LeakyReLU()

        self.conv_6 = Conv2D(32, (3, 3), strides=(1, 1), padding='same', dilation_rate=(2, 2), kernel_initializer='random_normal')
        self.relu_6 = LeakyReLU()

        # self.conv_7 = Conv2D(32, (3, 3), strides=(1, 1), padding='same', dilation_rate=(2, 2), kernel_initializer='random_normal')
        # self.relu_7 = LeakyReLU()

        # self.conv_8 = Conv2D(32, (3, 3), strides=(1, 1), padding='same', dilation_rate=(4, 4), kernel_initializer='random_normal')
        # self.relu_8 = LeakyReLU()
        #
        # self.conv_9 = Conv2D(32, (3, 3), strides=(1, 1), padding='same', dilation_rate=(8, 8), kernel_initializer='random_normal')
        # self.relu_9 = LeakyReLU()
        #
        # self.conv_10 = Conv2D(32, (3, 3), strides=(1, 1), padding='same', dilation_rate=(16, 16), kernel_initializer='random_normal')
        # self.relu_10 = LeakyReLU()
        #
        # self.conv_11 = Conv2D(32, (3, 3), strides=(1, 1), padding='same', dilation_rate=(1, 1), kernel_initializer='random_normal')
